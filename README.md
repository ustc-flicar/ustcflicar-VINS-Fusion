# Hello
#### This is a [VINS-Fusion](https://github.com/HKUST-Aerial-Robotics/VINS-Mono) fork for USTC FLICAR Dataset
...
Download [USTC FLICAR Dataset](https://ustc-flicar.github.io/datasets/) to YOUR_DATASET_FOLDER. Take HF001 for example, you can run VINS-Fusion with three sensor types (monocular camera + IMU, stereo cameras + IMU and stereo cameras). 
...
```
    roslaunch vins vins_rviz.launch
    rosrun vins vins_node YOUR_PROJECT_FOLDER/config/ustcflicar/ustcflicar_stereo_imu_config.yaml
    (optional) rosrun loop_fusion loop_fusion_node YOUR_PROJECT_FOLDER/config/ustcflicar/ustcflicar_stereo_imu_config.yaml 
    rosbag play YOUR_DATASET_FOLDER/hf001.bag
```
...
*If you use the USTC FLICAR dataset in your work, please cite our work using the BibTex code on the dataset [website](https://ustc-flicar.github.io/). Please also cite VINS-Fusion publications below.*
